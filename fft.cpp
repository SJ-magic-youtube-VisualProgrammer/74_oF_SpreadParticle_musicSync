...
/******************************
******************************/
double FFT::get_history(int TimeId, int FrameId) const
{
	return history[TimeId].val[FrameId];
}
...
/******************************
******************************/
void FFT::update_history()
{
	for(int i = NUM_HISTORY - 1; 0 < i; i--){
		history[i] = history[i - 1];
	}
	
	history[0].set(artSin_x3);
}
